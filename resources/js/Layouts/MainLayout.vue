<!-- Layout pour l'app quand connecté -->

<template>
  <DialogWindow v-show="showDialog" :message="message"/>
...
export default {
  ...
  methods: {
    openDialog (message) {
      this.message = message/* `Yeah! You just added ${this.form.quantity} ${this.selectedWine.name} to ${cellarName}` */
