<template>
  ...
  >
    ...
    <section class="blobs_bckgd">
        <figure class="fig_bg">
            <img src="@/../assets/img/blob_top.svg" class="blob_coral_bg" alt="">    
        </figure>
    </section> 

  <header class="nav_top_header">        
    <nav class="nav_top">
    <figure>
    ...
    <span>
          ...
          <Link aria-label="profile d'utilisateur" :href="route('profile.show', user.id)">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 25 25"><circle cx="12.5" cy="5.05" r="5.05"/><path d="m12.5,11.88C5.9,11.88.41,16.76,0,23c-.03.52.15,1.03.5,1.4.35.38.85.59,1.37.59h21.25c.52,0,1.01-.21,1.37-.59.35-.38.54-.89.5-1.4-.41-6.24-5.9-11.13-12.5-11.13Z"/></svg>
          </Link>
          <LanguageSelector class="nav_lang"/>                
    </span>
    </nav>        
  </header>
    
  <div class="cont_pad_vert_gral">
    <slot/>
  </div>
